...
for (var i in chinaData) {
	dataC.push({
		name: i,
		position: chinaData[i]
	})
...
var dataMap = [
	// SHOPIFY
	[
		[33.58, -117.62, "Orange County, CA, USA"],
		[63.45, 20.56, "Waterloo, ON, Canada"],
		[-59.94, 10.66, "Oslo, Norway"],
		[47.53, -121.85, "Snoqualmie, WA, USA"],
		[32.56, -92.05, "Monroe, LA, USA"],
	],

	/*  	[
			[32.56, -92.05, "Monroe, LA, USA"],
			[52.11, 6.05, "Eerbeek, Netherlands"],
			[34.03, -84.75, "Acworth, GA, USA"],
			[37.69, -113.05, "Cedar City, UT, USA"],
			[57.72, 12.03, "Göteborg, Sweden"],
			[39.15, -86.54, "Bloomington, IN, USA"]
		],  
